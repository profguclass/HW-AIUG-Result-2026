...
또한 인간응답자 효과(응답자가 AI가 아닌 인간일 때 제안비율이 증가하는 효과)가 나타났는데, 이는 AI모델들이 AI를 상대할 때 덜 관대한 조언을 한다는 선행연구의 결과를 재확인하고 있다. 그리고 선행연구에서처럼 금액크기(stake)에 따른 조정이 확인되었다. 네 모델 모두 판돈이 ₩10,000에서 ₩10,000,000으로 증가할수록 제안비율을 낮추는 경향을 보였다. 
